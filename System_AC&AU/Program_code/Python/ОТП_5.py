...
mySQLQuery = ("""
                SELECT [id] ,[id_prod], [name_prod], [od_vymiru], 			
...
for row in results:
    ...
    th = ['id', 'id_прод', 'назва', 'од.виміру', 'ціна', 'код_операції', 'вхід_зал_кілк', 'вхід_зал_сума',
          'надішло_кілк', 'надішло_сума', 'вибуло_кілк', 'вибуло_сума', 'залиш_кілк', 'залиш_сума']
